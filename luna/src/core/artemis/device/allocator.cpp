...
namespace luna 
{
	namespace artemis 
	{
		...
		void allocator::transitionImageLayoutFront(image& image,const VkImageLayout currentLayout,const VkImageLayout newLayout)
		{
			...
			else if (currentLayout == VK_IMAGE_LAYOUT_PRESENT_SRC_KHR && newLayout == VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL)
			{
			...
			else if (currentLayout == VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL && newLayout == VK_IMAGE_LAYOUT_PRESENT_SRC_KHR)
			{

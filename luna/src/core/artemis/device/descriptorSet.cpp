...
namespace luna
{
	namespace artemis 
	{
		...
		{
			LN_ERR_FAIL_COND_MSG(*p_device == VK_NULL_HANDLE, "[Artemis] could not free descriptorSet device handle was invalid (VK_NULL_HANDLE)");
			LN_ERR_FAIL_COND_MSG(*p_descriptorPool == VK_NULL_HANDLE, "[Aretemis] the descriptorPool has already be destroyed and freeed the corresponding descriptorSets!");
			LN_ERR_FAIL_COND_MSG(_descriptorSet == VK_NULL_HANDLE, "[Aretemis] descriptor set has already be destroyed");

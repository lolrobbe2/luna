...
namespace luna 
{
	namespace artemis 
	{
		...
		image::image(const VkImage image, const VkImageView imageView, const vmaAllocation* p_allocation, const glm::vec2& extent, const VkFormat& format, const glm::vec4 uv) : artemis::image(image,p_allocation,extent,format,uv)
		{

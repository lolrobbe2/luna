...
namespace luna 
{
	namespace networking
	{
		...
		public:
            ...
            {
                /**
                 * @brief The server has received the request headers and the client should proceed to send the request body
                ...
                /**
                 * @brief A WebDAV request may contain many sub-requests involving file operations, requiring a long time to complete the request.
                ...
                /**
                 * @brief The server is delivering only part of the resource (byte serving) due to a range header sent by the client.
                ...
                /**
                 * @brief The message body that follows is an XML message and can contain a number of separate response codes,
                 * depending on how many sub-requests were made.
                 */
                MULTI_STATUS = 207,

                /**
                 * @brief The members of a DAV binding have already been enumerated in a preceding part of the (multistatus) response,
                ...
                /**
                 * @brief Indicates multiple options for the resource from which the client may choose (via agent-driven content negotiation).
		...
		private:
			...
			void parseResponse(std::string responseString);
		};
	}
}
